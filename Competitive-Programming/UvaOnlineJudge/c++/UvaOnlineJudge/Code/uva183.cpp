...
static void BtoD_2(int begin_row, int end_row, int begin_col, int end_col)
{
...
static void BtoD(int row_count, int col_count)
{
	output_index = 0;
	printf("D%4d%4d\n", row_count, col_count);
...
static void DtoB_2(int begin_row, int end_row, int begin_col, int end_col)
{
	if (begin_row > end_row || begin_col > end_col)
		return;
...
static void DtoB(int row_count, int col_count)
{
	s_index = 0;
	printf("B%4d%4d\n", row_count, col_count);
